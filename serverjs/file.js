...
File.prototype.deleteFile = function(bucketName, bucketName, storage) {
  var deferred = Q.defer();
...
File.prototype.copyFile = function(srcBucketName, srcFilename, destBucketName, destFilename, storage) {
  var deferred = Q.defer();
